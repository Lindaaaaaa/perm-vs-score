...
%           pval is the p-value
function [flag, pval] = SKATPermTestmultiKernel2(y, X, K, nPerm,tol, maxIter, alg)
...
% start permutation  
    ...
    [flag(i),tauSq] = REML(yperm, X, K(:,:,ind), tol, maxIter, alg); % Important to remove Ki when testing tau_i
